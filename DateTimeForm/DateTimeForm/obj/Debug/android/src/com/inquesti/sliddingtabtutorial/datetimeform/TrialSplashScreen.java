package com.inquesti.sliddingtabtutorial.datetimeform;
...
public class TrialSplashScreen extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen.this, md5ca0952ebe1cef7a4a71ae006316d7ae6.MainActivity.class);
